...
class ConditionalVAE(vae.VAE):
    ...
    def step(self, batch, batch_idx, kl_coeff):
        ...
        loss, logs = self.compute_vae_loss(
            action, action_recon, p, q, kl_coeff)
    ...
    def _decoder_divergence(self, context):
        if self.latent_dim != 2:
            print(
                "WARNING: latent dim != 2 and decoder divergence may not be meaningful.")
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--compute_divergence",
